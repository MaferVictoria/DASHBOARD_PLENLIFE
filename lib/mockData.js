...
// Meta/Google return {month, spend, sales} pairs (for the spend-vs-sales
// combo charts). Shopify returns {month, sales, orders} (for the
// sales-vs-order-count combo chart).
